...
class CPage extends CHtmlBlock
{
	function parseBlock(&$html)
	{
        ...
        $pagerOnPage = 20;
        $pagerUrl = g('path','url_administration') . 'blogs_comments.php?p=%s';

        $itemsTotal = CBlogsTools::countCommentsNew();
        $items = CBlogsTools::getCommentsNew((($page - 1) * $pagerOnPage) . ',' . $pagerOnPage);
...
$page = new CPage("main", $g['tmpl']['dir_tmpl_administration'] . "blogs_comments.html");
